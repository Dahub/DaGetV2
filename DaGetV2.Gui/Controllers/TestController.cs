...
namespace DaGetV2.Gui.Controllers
{
    public class TestController : Controller
    {
        ...
        {
            string req = "http://authapi.daoauth.fr/authorize?response_type=code&client_id=kz5009TPNyJE7kaV&scope=RW_bank_account&state=test&redirect_uri=http%3A%2F%2Flocalhost:52941/Test/Return";
            return Redirect(req);
        }

        //public async void Return(string code, string error, string error_description)
        //{
            ...
            //    { new StringContent("kz5009TPNyJE7kaV"),  "client_id" },
            //    { new StringContent("RW_bank_account"),  "scope" },
            ...
            //          Encoding.UTF8.GetBytes("kz5009TPNyJE7kaV:1W4qX3vim5otU1sR")));
