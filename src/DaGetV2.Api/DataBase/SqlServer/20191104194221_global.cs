    ...
    public partial class global : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Wording = table.Column<string>(type: "nvarchar(512)", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    ModificationDate = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("15f2a0f2-71f0-4823-8798-77cfa5752014"), new DateTime(2019, 11, 4, 20, 42, 21, 274, DateTimeKind.Local).AddTicks(2088), new DateTime(2019, 11, 4, 20, 42, 21, 277, DateTimeKind.Local).AddTicks(4401), "Courant" });

            migrationBuilder.InsertData(
                schema: "daget",
                table: "BankAccountType",
                columns: new[] { "Id", "CreationDate", "ModificationDate", "Wording" },
                values: new object[] { new Guid("c146e49e-5884-4174-81f3-e26a5f2cf8cd"), new DateTime(2019, 11, 4, 20, 42, 21, 277, DateTimeKind.Local).AddTicks(5636), new DateTime(2019, 11, 4, 20, 42, 21, 277, DateTimeKind.Local).AddTicks(5662), "Epargne" });
